...
page_title: "powerflex_snapshotpolicy Data Source - powerflex"
subcategory: ""
description: |-
  .
---

# powerflex_snapshotpolicy (Data Source)
...
- `links` (Attributes List) Specifies the links asscociated for a volume. (see [below for nested schema](#nestedatt--snapshotpolicies--links))
