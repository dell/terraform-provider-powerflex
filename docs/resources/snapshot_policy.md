...
After the execution of above resource block, snapshot policy would have been created on the PowerFlex array. For more information, please check the terraform state file.
