...
# Example for configuring erasure coding on a storage pool
...
After the execution of above resource block, erasure coding policy would have been configured on the storage pool. For more information, please check the terraform state file.
