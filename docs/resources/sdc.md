...
subcategory: ""
description: |-
  This resource is used to manage the SDC entity of the PowerFlex Array. We can Create, Update and Delete the PowerFlex SDC using this resource. We can also Import an existing SDC from the PowerFlex array.
---
