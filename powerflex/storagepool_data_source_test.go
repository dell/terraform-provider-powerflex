		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.powerflex_storage_pool.example1", "protection_domain_id", "4eeb304600000000"),
				),
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.powerflex_storage_pool.example2", "protection_domain_id", "4eeb304600000000"),
				),
			},
			{
