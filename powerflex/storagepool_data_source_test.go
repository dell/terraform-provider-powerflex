		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.powerflex_storage_pool.example2", "storage_pools.1.id", "c992bad600000005"),
...
data "powerflex_storage_pool" "example2" {
	protection_domain_id = "` + protectionDomainID1 + `"
	storage_pool_ids = ["c98e26e500000000", "c992bad600000005"]
}
`
