		...
		Steps: []resource.TestStep{
			// create sds test
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceName, "protection_domain_id", protection_domain_id),
		...
		Steps: []resource.TestStep{
			...
			// create sds test valid
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("powerflex_sds.sds", "protection_domain_id", protection_domain_id),
