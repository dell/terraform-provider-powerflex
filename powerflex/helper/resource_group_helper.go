...
// GetResourceGroupState converts scaleiotypes.Template to models.Template
func GetResourceGroupState(input *scaleiotypes.ServiceResponse) models.ResourceGroupResourceModel {
	return models.ResourceGroupResourceModel{
...
// UpdateResourceGroupState - function to update state file for ResourceGroup resource.
func UpdateResourceGroupState(deploymentResponse *scaleiotypes.ServiceResponse, plan models.ResourceGroupResourceModel) (models.ResourceGroupResourceModel, diag.Diagnostics) {
	var diags diag.Diagnostics

	state := GetResourceGroupState(deploymentResponse)
...
// HandleResourceGroupDeployment - function to handle ResourceGroup deployment.
func HandleResourceGroupDeployment(ctx context.Context, deploymentResponse *scaleiotypes.ServiceResponse, plan models.ResourceGroupResourceModel, gatewayClient *goscaleio.GatewayClient) (*scaleiotypes.ServiceResponse, diag.Diagnostics) {
	...
	for couterForStopExecution <= deadLineCount {
		...
		if deploymentResponse.Status == "complete" {
			...
			if errorMsg != "" {
				diags.AddError("Error in deploying ResourceGroup", errorMsg)
			}
...
// GetDataSourceResourceGroupState  is the function to update the state file
func GetDataSourceResourceGroupState(input scaleiotypes.ServiceResponse) models.ResourceGroupModel {
