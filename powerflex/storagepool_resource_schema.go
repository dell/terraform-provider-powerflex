...
var StoragepoolReourceSchema schema.Schema = schema.Schema{
	...
	Attributes: map[string]schema.Attribute{
		"id": schema.StringAttribute{
			Description:         "ID of the Storage pool. added a line for tetsing purpose",
			MarkdownDescription: "ID of the Storage pool. added a line for tetsing purpose",
			Computed:            true,
		},
		"protection_domain_id": schema.StringAttribute{
			Description: "ID of the Protection Domain under which the storage pool will be created. added a line for tetsing purpose" +
				" Conflicts with 'protection_domain_name'." +
				" Cannot be updated.",
			MarkdownDescription: "ID of the Protection Domain under which the storage pool will be created. added a line for tetsing purpose" +
				" Conflicts with `protection_domain_name`." +
				" Cannot be updated.",
			Optional: true,
			Computed: true,
