...
resource "powerflex_nvme_host" "nvme_host_test" {
		name              = "nvme_acc_client1001_update"
		nqn               = "nqn.2014-08.org.nvmexpress:uuid:a10e4d56-a2c0-4cab-9a0a-9a7a4ebb8c0e"
		max_num_paths     = 8
		max_num_sys_ports = 8
}
		...
		Steps: []resource.TestStep{
			// create and read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "name", "nvme_acc_client1001"),
			...
			// update testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr(resourceName, "name", "nvme_acc_client1001_update"),
