...
# }
# Step 4 - execute the command: terraform import "powerflex_storagepool.resource_block_name" "id_of_the_volume" (resource_block_name must be taken from step 3 and id must be taken from step 2)
