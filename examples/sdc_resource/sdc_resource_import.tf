...
# Example :
# resource "powerflex_sdc" "var_name" {
# }
# Step 4 - execute the command : terraform init && terraform import "powerflex_sdc.var_name" "id_of_the_sdc" (var_name must be taken from step 3 and id must be taken from step 2)
