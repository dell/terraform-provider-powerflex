...
# Example :
# resource "powerflex_sds" "var_name" {
# }
# Step 4 - execute the command: terraform import "powerflex_sds.var_name" "id_of_the_sds" (var_name must be taken from step 3 and id must be taken from step 2)
