...
# name and nqn is the required parameter to create
...
# Example for changing NVMe host.
resource "powerflex_mdm_cluster" "test-nvme-host" {
  name              = "nvme_host_name_1"
  nqn               = "nqn.2014-08.org.nvmexpress:uuid:a10e4d56-a2c0-4cab-9a0a-9a7a4ebb8c0e"
  max_num_paths     = 8
  max_num_sys_ports = 16
}
